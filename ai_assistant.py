...
def run_alexa():
  with sr.Microphone() as source:
    ...
    try:
        ...
        if 'hello' in command :
        ...
        elif 'can i exit this' in command :
            print('''Say Bye bye or Stop or tata or vanakkam''')
            engine_talk('''Say Bye or Stop or tata or vanakkam to exit from this virtual assistant''')

        elif 'can i exit' in command :
            print('''Say Bye or Stop or tata or vanakkam''')
            engine_talk('''Say Bye or Stop or tata or vanakkam to exit from this virtual assistant''')
            ...
            engine_talk('opening tele gram...')
            webbrowser.open_new('https://web.telegram.org/')

        elif 'open linkedin' in command :
            print('opening linkedin ...')
            engine_talk('opening linkded in...')
